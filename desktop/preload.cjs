...
contextBridge.exposeInMainWorld("desktopData", {
  ...
  duplicateWorkspaceNode: (payload = {}) => ipcRenderer.invoke("desktop:data:duplicate-workspace-node", payload),
  ...
  revealWorkspaceNode: (payload = {}) => ipcRenderer.invoke("desktop:data:reveal-workspace-node", payload),
