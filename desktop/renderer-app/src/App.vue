...
const buildThemeAccentThemeStyle = ({ enabled = false, rgb = null, saturation = 100, dark = false } = {}) => {
  ...
  return {
    ...
    "--yc-wikilink-menu-item-hover-bg": rgbToCss(linkRgb, dark ? 0.22 : 0.16),
    "--yc-wikilink-menu-item-hover-text": rgbToCss(linkHoverRgb),
    "--yc-wikilink-menu-item-hover-detail": rgbToCss(linkHoverRgb),
    "--yc-wikilink-menu-item-hover-meta-bg": rgbToCss(linkRgb, dark ? 0.18 : 0.14),
    "--yc-wikilink-menu-item-hover-meta-text": rgbToCss(linkHoverRgb),
    "--yc-wikilink-menu-hint-token": rgbToCss(linkRgb),
